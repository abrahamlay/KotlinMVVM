...
class MultiplyFunctionViewModel(private val interactor: MultiplyFunctionInteractor) : ViewModel(), CalculateListener {
    ...
    class Factory(private val addFunctionInteractor: MultiplyFunctionInteractor) :
        ViewModelProvider.NewInstanceFactory() {

        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            return MultiplyFunctionViewModel(addFunctionInteractor) as T
        }
    }
}